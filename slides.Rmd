...
## To study IBE we have to account for IBD {.columns-2}
...
```{r ex_gaussian_field, cache=TRUE}
...
**Note:** BEDASSLE also estimates posterior densities for *allele-specific* $\mu$ and $\Theta$ parameters.
...
## Empirical example: altitude adaptation in maize?
...
To cheat, look at `bedassle-ex/view-bedassle-sim.Rmd`.
