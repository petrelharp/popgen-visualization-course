---
title: "Example BEDASSLE run: HGDP"
author: Peter Ralph
date: March 25, 2015
---
...
```{r setup}
library(BEDASSLE)
show(load("hgdp-ex/HGDP_EX3_MCMC_output1.Robj"))
fig.dim <- 5
require(knitr)
...
```{r third_as}
layout(t(1:2))
plot(aD[-(1:100)], xlab="MCMC generation", ylab="value", main="aD")
plot((aD_accept/aD_moves)[-(1:100)], xlab="MCMC generation", ylab="", main="aD acceptance", ylim=c(0,1))
